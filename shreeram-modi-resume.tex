...
\begin{compactitem}
  ...
  \item
    Created and maintaining mobile/desktop websites of CEDA debate team
...
\begin{compactitem}
  ...
  \item
    Conducted simulation debates using proprietary Scala platform and
    aggregated data and outcomes for analysis.

  \item
    Improved quality of data gathered through prompt adjustment and
    meta-analysis from participant feedback sessions.
\end{compactitem}
...
\begin{compactitem}
  ...
  \item
    Organized contact and demand lists, donated hundreds of PPE kits to local organizations and hospitals.
\end{compactitem}
