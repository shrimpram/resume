...
\goodbreak\vspace{\secskip}\par\noindent\begin{tabularx}{\linewidth}{Xr}
    \textbf{West Valley College} & \textbf{Courses:}\\
    \textit{Summer 2020} & \textit{BUSN 28 -- Business Law}\\
\end{tabularx}
...
\goodbreak\vspace{\secskip}\par\noindent\begin{tabularx}{\linewidth}{Xr}
    \textbf{De Anza College} & \textbf{Courses:}\\
    \textit{Winter 2020} & \textit{POLI 5 -- Intro to Political Thought and Theory}\\
    \textit{Spring 2021} & \textit{ANTH 2 -- Cultural Anthropology}\\
\end{tabularx}
%\goodbreak \hspace{-1.25em} Courses:
%\begin{compactitem}
...
\goodbreak\vspace{\secskip}\par\noindent\begin{tabularx}{\linewidth}{Xr}
    \textbf{Florida Virtual High School} & \textbf{Courses:}\\
    \textit{Winter 2020} & \textit{AP Macroeconomics}\\
\end{tabularx}
%\goodbreak \hspace{-1.25em} Courses:
%\begin{compactitem}
